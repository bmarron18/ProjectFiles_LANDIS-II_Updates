...
set workingdir=C:\Users\lucash\Documents\LANDIS_runs\Chapter_8_BatchFiles\output

rem This next line below (homedir) is where the inputs are found.
set homedir=C:\Users\lucash\Documents\LANDIS_runs\Chapter_8_BatchFiles

if not exist %workingdir%\%1\replicate%2 mkdir %workingdir%\%1\replicate%2
c:
cd %workingdir%\%1\replicate%2
copy C:\Users\lucash\Documents\LANDIS_runs\Chapter_8_BatchFiles\%1.txt
call landis %1.txt 
c:
cd %homedir%
